<div class='container'>
    <div class="">
        <div class='row d-flex justify-content-center '>    
			...
			<?=form_open(base_url('welcome/registrasi'),'method="post"')?>
				<?php
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="password1" id="exampleInputPassword2" placeholder="Confirm Password"/>
                </div>
